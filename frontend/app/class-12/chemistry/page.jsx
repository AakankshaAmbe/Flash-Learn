...
export default function Chemistry12Page() {
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    ...
    >
      ...
      <main className="container mx-auto px-4 py-12 relative z-10">
        ...
        >
          ...
          <h2 className="text-5xl font-bold text-white mb-4">Chemistry - Class 12</h2>
          <p className="text-xl text-gray-100 max-w-3xl mx-auto">
            Master advanced chemistry concepts for boards and competitive exams.
            Explore solid state, electrochemistry, kinetics, organic chemistry, and more.
          </p>
        </motion.div>
          ...
          <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-12 text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-100 mb-8 text-lg">
                Understand crystal structures, reaction mechanisms, kinetics, and functional groups in an engaging 3D way.
              </p>
